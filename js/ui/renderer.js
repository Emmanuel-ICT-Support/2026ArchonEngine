(function (ns) {
  ...
  var ACTIVATION_SEQUENCE_CONFIGS = {
    human: {
      frameSrcs: [
        "assets/ui/archon/human-activation/human_activation_01.png",
        "assets/ui/archon/human-activation/human_activation_02.png",
        "assets/ui/archon/human-activation/human_activation_03.png",
        "assets/ui/archon/human-activation/human_activation_04.png",
        "assets/ui/archon/human-activation/human_activation_05.png",
        "assets/ui/archon/human-activation/human_activation_06.png",
        "assets/ui/archon/human-activation/human_activation_07.png",
        "assets/ui/archon/human-activation/human_activation_08.png",
        "assets/ui/archon/human-activation/human_activation_09.png",
        "assets/ui/archon/human-activation/human_activation_10.png",
        "assets/ui/archon/human-activation/human_activation_11.png",
        "assets/ui/archon/human-activation/human_activation_12.png"
      ],
      fallbackSrc: "assets/ui/archon/human-side.png",
      needsChromaKey: false
    },
    ai: {
      frameSrcs: [
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_01.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_02.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_03.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_04.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_05.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_06.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_07.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_08.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_09.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_10.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_11.png",
        "assets/ui/archon/ai-activation/ai_activation_greenscreen_12.png"
      ],
      fallbackSrc: "assets/ui/archon/consensus-intel-icon.png",
      needsChromaKey: true
    }
  };
  ...
  function renderRemnantCommandCard(options) {
    ...
    var iconMarkup = settings.activationSequence === "human"
      ...
      : '<img class="placeholder-card__icon" src="assets/ui/archon/human-side.png" alt="Remnant command icon" loading="eager" decoding="async" />';
  ...
  function renderConsensusIntelCard(options) {
    ...
    var iconMarkup = settings.activationSequence === "ai"
      ...
      : '<img class="placeholder-card__icon" src="assets/ui/archon/consensus-intel-icon.png" alt="Consensus intel icon" loading="eager" decoding="async" />';
  ...
  function renderFactionCrest(side) {
    ...
    var medallionSrc =
      side === "light"
        ? "assets/ui/archon/remnant-medallion.png"
        : "assets/ui/archon/consensus-medallion.png";
    ...
    function renderEthicalDecision(state) {
      ...
      if (!pending) {
        ...
        if (ethicalAdvanceIcon) {
          ethicalAdvanceIcon.setAttribute("src", "assets/ui/archon/consensus-ai-side-alpha.png");
        }
      ...
      advanceIconSrc = isComputerDecision
        ? "assets/ui/archon/consensus-ai-side-alpha.png"
        : "assets/ui/archon/human-side-alpha.png";
      if (ethicalAdvanceButton) {
